...
<body>
	...
	<div class="card">
		<form:form class="box" action="saveDept" modelAttribute="dept"
			method="POST">
			<h1>Department Form</h1>
			<form:hidden path="id"/>
			<form:input type="text" path="dept_name" placeholder="Department's Name"/>
			<form:input type="text" path="dept_details" placeholder="Details"/>
